...
|-------------|---------------------|
| [src/main/java/org/jabref/gui/journals/AbbreviateAction.java](https://github.com/JabRef/jabref/blob/fixabbreviate/src/main/java/org/jabref/gui/journals/AbbreviateAction.java) | [View File]() |

## ProductMap - Contact Us
For any inquiries, feel free to [contact us](https://product-map.ai).
\n\n Last updated on Sat Mar 15 16:22:29 UTC 2025
